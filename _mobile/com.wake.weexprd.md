...
- tradeAlts
redirect_from:
- /android/com.wake.weexprd/
- /iphone/com.wake.weexprd/
android:
...
{% include featureEvidence.html feature="buyWithCC" quote="Buy crypto via Apple Pay, Google Pay, Visa, Mastercard, bank transfers, and global fiat on-ramps" source="Store" %}

{% include featureEvidence.html feature="tradeAlts" quote="With 1,700+ trading pairs, up to 400× leverage, and a focus on security and simplicity, WEEX empowers both new and experienced traders." source="Store" %}
