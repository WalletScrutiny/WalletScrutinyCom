...
{% include featureEvidence.html feature="tradeAlts" quote="Buy, sell, and hold Bitcoin, Ethereum, Solana, Cardano, USDT, USDC, BNB, and +35 more, all on one platform." source="Store description" %}

{% include featureEvidence.html feature="buyWithCC" quote="Easily top-up your investment balance from the main dashboard." source="Store description" %}

{% include featureEvidence.html feature="fingerprint" quote="app users have access to the added layer of protection available through Touch ID and Face ID access." source="Store description" %}
