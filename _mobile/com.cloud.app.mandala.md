...
appCountry: us
redirect_from:
- /android/com.cloud.app.mandala/
- /iphone/com.cloud.mandala/
android:
...
Mandala claims to be [hosted on Binance Cloud](https://www.mandala.exchange/post/mandala-where-security-is-paramount#deadLink), Binance's hosting solution for cryptocurrency exchanges. 
...
However, Binance itself does not name any specific exchanges [on its webpage concerning this service.](https://cloud.binance.com#deadLink)
