...
{% include featureEvidence.html feature="buyWithCC" quote="Credit Card (Visa,Mastercard)" source="Store" %}

{% include featureEvidence.html feature="tradeAlts" quote="buy, sell, and store over 150 different cryptocurrencies, including Bitcoin, Ethereum, Litecoin, Cardano, and many more." source="Store" %}
