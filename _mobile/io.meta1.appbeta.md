...
redirect_from:
- /android/io.meta1.appbeta/
- /iphone/io.meta1.appbeta/
android:
...
- This app is also known as the Meta 1 Lite Wallet as seen from this [page](https://meta-exchange.vision/home#deadLink).
...
- We can see from this [help document](https://support.meta1coin.vision/hc/en-us/articles/16567681846555-How-to-buy-META-1-coin#deadLink) a screenshot which shows an option to deposit or send Bitcoin.
- Somehow, we find ourselves on their exchange with a [BTC/USDT](https://meta-exchange.vision/market/BTC_USDT#deadLink) trading pair.
- As evidenced in this [video](https://support.meta1coin.vision/hc/en-us/articles/11552910107931-How-to-create-paper-wallet-#deadLink), the private keys can be generated by selecting the "generate a paper wallet" option. From there, the user inputs a "passkey" which then creates the paper wallet PDF file which contains the private key. [(Picture taken from tutorial page)](https://twitter.com/BitcoinWalletz/status/1699039947179905303)
...
- Several attempts to contact the developer has been made with no response from them. 
  - Emanuel on [GitHub Issues](https://github.com/META-1-Official/litewallet-native/issues/95#issue-1985378988&deadLink) - November 9, 2023
