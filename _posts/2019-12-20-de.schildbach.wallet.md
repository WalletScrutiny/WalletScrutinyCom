...
Files /tmp/fromPlay_de.schildbach.wallet_801/apktool.yml and /tmp/fromBuild_de.schildbach.wallet_801/apktool.yml differ
Only in /tmp/fromPlay_de.schildbach.wallet_801/original/META-INF: BITCOIN-.RSA
Only in /tmp/fromPlay_de.schildbach.wallet_801/original/META-INF: BITCOIN-.SF
Files /tmp/fromPlay_de.schildbach.wallet_801/original/META-INF/MANIFEST.MF and /tmp/fromBuild_de.schildbach.wallet_801/original/META-INF/MANIFEST.MF differ
```

That is what we expected to again give this app the verdict **verifiable**.