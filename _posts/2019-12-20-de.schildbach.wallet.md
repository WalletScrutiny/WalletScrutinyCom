...
- severity: medium
  ...
  message: |
    ...
    enforcement etc. To improve the privacy
    
    * You can connect exclusively to your own full node using SSL
    * The provider has to fix
      [this issue](https://github.com/bitcoin-wallet/bitcoin-wallet/issues/358).
date: 2020-06-20
reviewStale: true
