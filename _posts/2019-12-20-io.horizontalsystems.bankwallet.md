...
- severity: medium
  short: Weak privacy!
  message: >
    This app invites you to adjust your privacy settings before even creating
    a wallet. This is great but in the privacy settings for Bitcoin, "API" is
    recommended and "From Blockchain" is featured as "More Private" but both
    options have very questionable privacy properties:
    
    * If you choose "From Blockchain", random Bitcoin nodes - many of which are
      run by surveillance companies - will learn what addresses you use. These
      companies share the data with their paying customers like exchanges,
      law enforcement agencies and tax authorities.
      
    * If you choose "API", the provider of the API - supposedly the same as the
      provider of this app - gets access to that same data and might or might
      not sell it to the same surveillance companies.
    
    Using the provided TOR feature only marginally improves the situation. If
    you ever use this app to pay at a merchant or receive from an exchange that
    know your real name, all your addresses will be associated to your name
    regardless of your IP address being shielded by TOR.
date: 2020-07-15
reviewStale: false
