...
Here we test if version `3.3.4` is verifiable. See older reviews for more.
...
Files /tmp/fromPlay_com.greenaddress.greenbits_android_wallet_22000334/apktool.yml and /tmp/fromBuild_com.greenaddress.greenbits_android_wallet_22000334/apktool.yml differ
Only in /tmp/fromPlay_com.greenaddress.greenbits_android_wallet_22000334/original/META-INF: GREENADD.RSA
Only in /tmp/fromPlay_com.greenaddress.greenbits_android_wallet_22000334/original/META-INF: GREENADD.SF
Files /tmp/fromPlay_com.greenaddress.greenbits_android_wallet_22000334/original/META-INF/MANIFEST.MF and /tmp/fromBuild_com.greenaddress.greenbits_android_wallet_22000334/original/META-INF/MANIFEST.MF differ
```

And that diff looks exactly as it should look. Our verdict for version 3.3.4:
