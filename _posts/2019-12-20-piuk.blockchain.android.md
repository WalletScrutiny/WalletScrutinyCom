...
- severity: high # will be rendered with a red exclamation mark
  short: Provider controls all lightning channels
  message: >
    Although you own the keys for your side of the channel, you will
    have no access to the channel state and the provider controls the other end
    of your channel. This means if he can provoke a down-time of your client, he
    can steal some of your funds!
- severity: medium # will be rendered with a yellow exclamation mark
  short: Not all features are non-custodial!
  message: Not all features are non-custodial and the disclaimers are ambiguous!
- severity: low # will be rendered with a gray exclamation mark
