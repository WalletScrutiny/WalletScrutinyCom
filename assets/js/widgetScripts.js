...
function getWidgetHtml(wallet, includeDetails) {
  ...
  <div style="padding: .75rem .25rem .25rem 1rem;display: flex;flex-direction: row;flex-wrap: wrap;align-items: center;justify-content: end;width: 100%;position: fixed;bottom: 0;right: 0;">
    <a target="_blank" title="Verifiability data provided by Wallet Scrutiny" href="https://walletscrutiny.com${wallet.url}" style="text-decoration: none;font-family: sans-serif;font-size: 11px;margin-right: 10px;color: var(--blue, #0064ff);display: block;">Full Analysis</a>
