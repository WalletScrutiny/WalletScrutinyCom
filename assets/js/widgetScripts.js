...
window.addEventListener('load', () => {
  function getWidgetHtml (wallet, includeDetails) {
    ...
    return `<a target="_blank" style="display: flex;flex-direction: row;justify-content: start;align-items: center;text-decoration: none;color: var(--text, #222);${wallet.meta === 'outdated' ? 'filter: grayscale() blur(2px)' : ''}" href="https://walletscrutiny.com/${wallet.folder}/${wallet.appId}/">
