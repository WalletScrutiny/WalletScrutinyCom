...
const client = new btcpay.BTCPayClient(
  ...
  keypair,
  {
    merchant: 'EHan8qV5JseDSNWtTJeaNFeG3xes9CDSq3bMfmwehcJE'
  });
...
`);
  invoices.slice(0, historyCount).forEach(invoice => {
    ...
    file.write(`<tr><td><span title='${date.toLocaleDateString()
      }' class='calculate-time-elapsed' data='${date.valueOf() / 1000}'>${
      date.toLocaleDateString()}</span></td><td>${getPrettyAmount(
