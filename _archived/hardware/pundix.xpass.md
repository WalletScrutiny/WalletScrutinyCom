...
It can be used to purchase products in stores with a {% include walletLinkArchived.html wallet='hardware/pundix.pos' %}.
...
The device needs to be paired either with the {% include walletLink.html wallet='android/com.pundix.xwallet' verdict='false' %} or the {% include walletLinkArchived.html wallet='hardware/pundix.pos' %} in order to function. 
