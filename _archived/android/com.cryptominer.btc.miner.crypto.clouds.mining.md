...
It should be noted that this app and its description strongly resembles apps such as {% include walletLinkArchived.html wallet='android/com.cryptominer.btc.miner.cloud.mining' %} and {% include walletLink.html wallet='android/com.btccloudminer.easy' verdict='false' %}
