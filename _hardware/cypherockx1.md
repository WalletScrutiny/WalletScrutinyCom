...
* On Git Bash Shell, checkout using tag:
        ...
        MINGW64 ~/Desktop/Cypherock/X1_wallet/Firmware/v0.4.773 ((v0.4.773)) $ git clone git@github.com:Cypherock/x1_wallet_firmware.git .  --recurse-submodules
...
* On Powershell, setup Docker and compile:
        PS C:\Users\LENEVO\Desktop\Cypherock\X1_wallet\Firmware\v0.4.773>  docker build . --file Dockerfile --tag x1-wallet-app-env
        PS C:\Users\LENEVO\Desktop\Cypherock\X1_wallet\Firmware\v0.4.773>  docker run -v ${pwd}/build:/out -it x1-wallet-app-env /bin/ash
        .
        .
