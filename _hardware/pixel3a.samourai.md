...
An unconventional approach to "refit" **used** Google Pixel 3A's into hardware wallets culminated in this effort. It was initially described in an article on BitcoinMagazine ["HOW TO ESTABLISH MOBILE BITCOIN PRIVACY WITH A PIXEL 4A AND CALYXOS"](https://bitcoinmagazine.com/guides/how-to-establish-mobile-bitcoin-privacy-with-a-pixel-4a-and-calyxos).

Graphene OS and CalyxOS are both mobile OS's with emphasis on security and privacy. 
