...
From the sparse description we could find, we saw that it consists of a development board or a [Single Board Computer](https://en.wikipedia.org/wiki/Single-board_computer). 
