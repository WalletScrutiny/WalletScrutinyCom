...
Coinus further describes itself as a "decentralized wallet" as evidenced in its [Wallet Restoration Page](https://support.coinus.io/hc/ko/articles/360031503271-%EC%A7%80%EA%B0%91-%EB%B3%B5%EC%9B%90%ED%95%98%EA%B8%B0).

- Mnemonic is 12 words in English, and QR Code consists of QR-type barcodes.
- **Coinus Wallet is a decentralized wallet that does not store and store customers' Mnemonic, QR Code, and Private Key, and is not responsible for loss or leakage of Mnemonic, QR Code, or Private Key.**
- If you restore with a different Mnemonic or QR code than the restore wallet, the other wallet will be restored.
