...
The website has a link to the Github repositories. It appears that this wallet is non-custodial and that source-code is available. However, we still require additional verification before we can make a verdict on this app.
