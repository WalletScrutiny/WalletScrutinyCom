...
It is related to {% include walletLinkArchived.html wallet='android/com.changelly.app/' %}, an exchange that claimed to be non-custodial as it only held funds for the purpose of exchanging them. This seems not to be the case for Changelly PRO.
