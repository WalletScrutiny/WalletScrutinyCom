...
According to their Google Play app description page:

> Walletverse is a free self-custodial DeFi (Decentralized Finance) crypto wallet app. This multi-currency crypto wallet supports a wide range of tokens and blockchains.

This list includes BTC. 
