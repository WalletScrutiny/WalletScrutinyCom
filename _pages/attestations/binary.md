...
<div class="explanation-box" style="margin-top: 2em; padding: 1em; border: 1px solid var(--border-color); border-radius: 4px;">
  <p>Above is the list of assets found in Nostr with the provided SHA256 hash. You can click on available attestations to view their details. If you've verified this binary by building it from source yourself, you can contribute by creating a new attestation to help others verify its authenticity.</p>
</div>
