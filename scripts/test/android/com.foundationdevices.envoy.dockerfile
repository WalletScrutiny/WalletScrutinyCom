...
RUN git clone https://github.com/Foundation-Devices/envoy.git /root/envoy
...
RUN chmod +x com.foundationdevices.envoy.build_ffi_android.sh && ./com.foundationdevices.envoy.build_ffi_android.sh
