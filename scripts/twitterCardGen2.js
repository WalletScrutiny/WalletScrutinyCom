    ...
    files.forEach((file) => {
        if (file.endsWith('.png')) {
            ...
            if (fs.existsSync(mdFilePath)) {
                ...
                let verdictDescription = `-pointsize 25 -fill black -draw "text 160,320 `;
                ...
                const propFieldX = 160;
                const propValX = propFieldX + 180;
                execSync(`convert ${twcardFolder}/twitterImageBG600x600.jpg -font ./assets/fonts/Barlow/barlow-v12-latin-600.ttf\
                    -fill black \
                    -pointsize 33 -kerning 0 -draw "text 160,170 \\"${title}\\"" \
                    -pointsize 20 -kerning -1 -fill gray -draw "text 160,220 \\"version: ${version}\\"" \
                    -pointsize 25 -fill black -draw "text 160,290 'This is the test information'" \
                    ${verdictDescription}\
                    -draw "stroke lightgray stroke-width 1.5 line 200,350 470,350" \
                    -kerning 0.5 -pointsize 22 -fill gray -draw "text ${propFieldX} ,400 'Developer'" -fill black -draw "text ${propValX},400 '${developerName}'" \
                    -fill gray -draw "text ${propFieldX} ,425 'Downloads'" -fill black -draw "text ${propValX},425 '${users}'" \
                    -fill gray -draw "text ${propFieldX} ,450'Released on'" -fill black -draw "text ${propValX},450 '${released}'" \
                    -fill gray -draw "text ${propFieldX} ,475 'Latest release'" -fill black -draw "text ${propValX},475 '${updated}'" \
                    -fill gray -draw "text ${propFieldX} ,500 'Latest review'" -fill black -draw "text ${propValX},500 '${date}'" \
                    ${iconPath} -geometry +30+130 -composite \
